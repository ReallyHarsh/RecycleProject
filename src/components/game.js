export const gameItems = [
    ...
    { name: 'Plastic Bottle', type: 'recycle', icon: 'ph-bottle', reason: 'PET plastic is highly recyclable!' },
    { name: 'Apple Core', type: 'compost', icon: 'ph-apple-logo', reason: 'Organic waste creates compost.' },
